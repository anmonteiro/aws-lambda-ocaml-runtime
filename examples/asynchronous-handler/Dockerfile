...
RUN esy b dune build examples/asynchronous-handler/basic.exe --profile=static

RUN mv $(esy bash -c 'echo $cur__target_dir/default/examples/asynchronous-handler/basic.exe') bootstrap
